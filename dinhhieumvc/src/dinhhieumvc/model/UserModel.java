...
import dinhhieumvc.validator.FieldMatch;
import dinhhieumvc.validator.NullOrNotBlank;
import dinhhieumvc.validator.UniqueEmail;

@FieldMatch.List({
		@FieldMatch(first = "password", second = "confirmation", 
				message = "{user.validation.password.notmatch}") })
...
public class UserModel extends BaseModel {
	...
	private boolean ratedByCurrentUser = false;
